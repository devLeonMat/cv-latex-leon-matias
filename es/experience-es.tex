...
\begin{cvItems}
  ...
  \cvItem{Definición de estándares, revisiones de código y liderazgo de equipo distribuido en
    ceremonias Agile; \textbf{CI/CD} con GitHub Actions y backend \textbf{event-driven} con
    Apache Kafka para coordinación de agentes en tiempo real.}
  \cvItem{Uso de \textbf{agentes IA} (Claude Code, GitHub Copilot, Cursor) para scaffolding,
